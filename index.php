...
$MIMEICONS = [
	...
	"application/json" => "fas fa-list",
	"application/x-sh" => "fas fa-terminal",
	"application/typescript" => "fas fa-code",
	"application/xhtml+xml" => "fas fa-code",
	"application/xml" => "fas fa-code",
	...
	"image/bmp" => "fas fa-image",
	"image/x-windows-bmp" => "fas fa-image",
